...
public:
  ...
  // that is why we pass pointer to MyGymEnv instance to be able to store the
  // context (node, etc)
  static void NotifyPktRxEvent(Ptr<MyGymEnv> entity, Ptr<Node> node,
                               Ptr<const Packet> packet);
  static void CountRxPkts(Ptr<MyGymEnv> entity, Ptr<Node> node,
                          Ptr<const Packet> packet);
