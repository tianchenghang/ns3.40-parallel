...
public:
  ...
  friend std::ostream &operator<<(std::ostream &os,
                                  const Ptr<OpenGymDiscreteSpace> space) {
    space->Print(os);
    return os;
  }
...
public:
  OpenGymBoxSpace();
  OpenGymBoxSpace(float low, float high, std::vector<uint32_t> shape,
                  std::string dtype);
  OpenGymBoxSpace(std::vector<float> low, std::vector<float> high,
  ...
  friend std::ostream &operator<<(std::ostream &os,
                                  const Ptr<OpenGymBoxSpace> space) {
    space->Print(os);
    return os;
  }
...
public:
  ...
  friend std::ostream &operator<<(std::ostream &os,
                                  const Ptr<OpenGymTupleSpace> space) {
    space->Print(os);
    return os;
  }
...
public:
  ...
  friend std::ostream &operator<<(std::ostream &os,
                                  const Ptr<OpenGymDictSpace> space) {
    space->Print(os);
    return os;
  }
