...
// for Nist, Yans and Table-based error rate models and for every HT MCS value.
...
int main(int argc, char *argv[]) {
  ...
  const std::vector<std::string> modes{
      "HtMcs0", "HtMcs1", "HtMcs2", "HtMcs3",
      "HtMcs4", "HtMcs5", "HtMcs6", "HtMcs7",
  };
  ...
  Ptr<TableBasedErrorRateModel> table =
