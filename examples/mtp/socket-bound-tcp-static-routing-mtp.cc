...
int main(int argc, char *argv[]) {
  ...
  staticRoutingDst->AddHostRouteTo(Ipv4Address("10.1.2.1"),
                                   Ipv4Address("10.20.1.1"), 1);
  staticRoutingDstRtr->AddHostRouteTo(Ipv4Address("10.1.2.1"),
                                      Ipv4Address("10.10.2.1"), 2);
  ...
  p2p.EnableAsciiAll(
      ascii.CreateFileStream("socket-bound-tcp-static-routing.tr"));
