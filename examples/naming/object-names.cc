...
int main(int argc, char *argv[]) {
  ...
  // "/Names/server/eth0". In this case, we again omit the "/Names/" prefix on
  // one call to illustrate the shortcut.
  //
  ...
  // to get to the server node, and then continue seamlessly adding named
  // objects in the path. This is not nearly as readable as the previous
  // version, but it illustrates how you can mix and match object names and
  // Attribute names. Note that the config path now begins with a path in the
  // "/NodeList" namespace.
  //
