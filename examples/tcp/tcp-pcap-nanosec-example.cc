...
int main(int argc, char *argv[]) {
  ...
  //
  // If requested via the --nanosec cmdline flag, generate nanosecond timestamp
  // for pcap traces
  //
  if (nanosec) {
  ...
  //
  // Explicitly create the point-to-point link required by the topology (shown
  // above).
  //
