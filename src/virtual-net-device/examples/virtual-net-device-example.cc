...
// - n0 will receive an extra virtual interface with hardcoded inner-tunnel
// address 11.0.0.1
// - n1 will also receive an extra virtual interface with the same inner-tunnel
// address 11.0.0.1
// - n3 will receive an extra virtual interface with inner-tunnel
// address 11.0.0.254
// - The flows will be between 11.0.0.x (inner-tunnel) addresses instead
// of 10.1.x.y ones
 ...
 *
 * Tunnel class - its goal is to create and manage the tunnels between
 * endpoints.
 */
class Tunnel {
