...
void MeshInformationElementVectorBist::DoRun() {
  ...
  {
    Ptr<dot11s::IeLinkMetricReport> report =
  ...
  }
  {
    ...
    preq->SetLifetime(4);
    preq->AddDestinationAddressElement(false, false,
                                       Mac48Address("11:11:11:11:11:11"), 5);
    preq->AddDestinationAddressElement(false, false,
                                       Mac48Address("22:22:22:22:22:22"), 6);
...
MeshTestSuite::MeshTestSuite() : TestSuite("devices-mesh", UNIT) {
