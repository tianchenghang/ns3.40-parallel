...
def main(argv):
    ...
    inet_sock_address = ns.network.InetSocketAddress(
        ns.network.Ipv4Address("10.1.1.2"), port
    )
    ...
    #
    inet_address = ns.network.InetSocketAddress(
        ns.network.Ipv4Address("10.1.1.1"), port
    )
