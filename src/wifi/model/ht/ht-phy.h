...
public:
   ...
   * For HT, this results in non-continuous indices for supported MCSs.
   *
   * \param maxIndex the maximum MCS index per spatial stream supported by this
   * entity
   *
   * The provided value should not be greater than maximum standard-defined
   * value.
   */
   ...
   * to the supplied HT MCS index. This function calls
...
protected:
  ...
  uint8_t m_maxMcsIndexPerSs; //!< the maximum MCS index per spatial stream as
                              //!< defined by the standard
  uint8_t m_maxSupportedMcsIndexPerSs; //!< the maximum supported MCS index per
                                       //!< spatial stream
...
private:
  ...
  uint8_t m_maxSupportedNss; //!< Maximum supported number of spatial streams
                             //!< (used to build HT MCS indices)
