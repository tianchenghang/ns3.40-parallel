...
private:
   ...
   * \param modClass the modulation class of the WifiMode, must be either
   * WIFI_MOD_CLASS_DSSS or WIFI_MOD_CLASS_HR_DSSS \return the DSSS or HR/DSSS
   * WifiMode
   */
  ...
  static const ModulationLookupTable
      m_dsssModulationLookupTable; //!< lookup table to retrieve code rate and
                                   //!< constellation size corresponding to a
                                   //!< unique name of modulation
};                                 // class DsssPhy
