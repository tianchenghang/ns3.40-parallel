 ...
 * \ingroup wifi
 *
 * OfdmPpdu stores a preamble, PHY headers and a PSDU of a PPDU with non-HT
 * header, i.e., PPDU that uses OFDM modulation.
 */
...
public:
   ...
   * \param instantiateLSig flag used to instantiate LSigHeader (set
   * LSigHeader's rate and length), should be disabled by child classes
   */
