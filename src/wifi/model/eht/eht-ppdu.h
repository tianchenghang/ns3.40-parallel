...
public:
  ...
  struct EhtMuPhyHeader {
    ...
    std::optional<RuAllocation>
        m_ruAllocationA; //!< RU Allocation-A that are going to be
                         //!< carried in EHT-SIG common subfields
    std::optional<RuAllocation>
        m_ruAllocationB; //!< RU Allocation-B that are going to be
                         //!< carried in EHT-SIG common subfields
   ...
   * an EHT TB PPDU \param flag the flag indicating the type of Tx PSD to build
   */
   ...
   * \return a pair containing the number of RUs in each EHT-SIG-B content
