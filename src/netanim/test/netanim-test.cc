...
void AbstractAnimationInterfaceTestCase::DoRun() {
  PrepareNetwork();
...
void AbstractAnimationInterfaceTestCase::CheckFileExistence() {
...
void AnimationInterfaceTestCase::PrepareNetwork() {
  m_nodes.Create(2);
...
void AnimationInterfaceTestCase::CheckLogic() {
  NS_TEST_ASSERT_MSG_EQ(m_anim->GetTracePktCount(), 16,
...
void AnimationRemainingEnergyTestCase::PrepareNetwork() {
