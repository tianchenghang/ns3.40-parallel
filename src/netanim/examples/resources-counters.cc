...
int main(int argc, char *argv[]) {
  ...
  resourceId2 =
      pAnim->AddResource("/Users/john/ns3/netanim-3.105/ns-3-logo2.png");
  ...
  nodeCounterIdDouble1 = pAnim->AddNodeCounter(
      "Double Counter 1", AnimationInterface::DOUBLE_COUNTER);
  nodeCounterIdDouble2 = pAnim->AddNodeCounter(
      "Double Counter 2", AnimationInterface::DOUBLE_COUNTER);
