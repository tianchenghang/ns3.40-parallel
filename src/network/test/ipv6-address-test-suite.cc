...
Ipv6AddressTestCase::Ipv6AddressTestCase() : TestCase("serialization code") {}

Ipv6AddressTestCase::~Ipv6AddressTestCase() {}

void Ipv6AddressTestCase::DoRun() {
...
Ipv6AddressTestSuite::Ipv6AddressTestSuite() : TestSuite("ipv6-address", UNIT) {
  AddTestCase(new Ipv6AddressTestCase, TestCase::QUICK);
}

static Ipv6AddressTestSuite
    ipv6AddressTestSuite; //!< Static variable for test initialization
