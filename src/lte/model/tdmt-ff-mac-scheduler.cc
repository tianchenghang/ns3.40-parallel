...
TdMtFfMacScheduler::~TdMtFfMacScheduler() { NS_LOG_FUNCTION(this); }

void TdMtFfMacScheduler::DoDispose() {
...
TypeId TdMtFfMacScheduler::GetTypeId() {
  static TypeId tid =
...
void TdMtFfMacScheduler::SetFfMacCschedSapUser(FfMacCschedSapUser *s) {
  m_cschedSapUser = s;
}

void TdMtFfMacScheduler::SetFfMacSchedSapUser(FfMacSchedSapUser *s) {
  m_schedSapUser = s;
}

FfMacCschedSapProvider *TdMtFfMacScheduler::GetFfMacCschedSapProvider() {
  return m_cschedSapProvider;
}

FfMacSchedSapProvider *TdMtFfMacScheduler::GetFfMacSchedSapProvider() {
  return m_schedSapProvider;
}

void TdMtFfMacScheduler::SetLteFfrSapProvider(LteFfrSapProvider *s) {
  m_ffrSapProvider = s;
}

LteFfrSapUser *TdMtFfMacScheduler::GetLteFfrSapUser() { return m_ffrSapUser; }

void TdMtFfMacScheduler::DoCschedCellConfigReq(
...
void TdMtFfMacScheduler::DoCschedUeConfigReq(
...
void TdMtFfMacScheduler::DoCschedLcConfigReq(
...
void TdMtFfMacScheduler::DoCschedLcReleaseReq(
...
void TdMtFfMacScheduler::DoCschedUeReleaseReq(
...
void TdMtFfMacScheduler::DoSchedDlRlcBufferReq(
...
void TdMtFfMacScheduler::DoSchedDlPagingBufferReq(
    const FfMacSchedSapProvider::SchedDlPagingBufferReqParameters &params) {
  NS_LOG_FUNCTION(this);
  NS_FATAL_ERROR("method not implemented");
}

void TdMtFfMacScheduler::DoSchedDlMacBufferReq(
    const FfMacSchedSapProvider::SchedDlMacBufferReqParameters &params) {
  NS_LOG_FUNCTION(this);
  NS_FATAL_ERROR("method not implemented");
}

int TdMtFfMacScheduler::GetRbgSize(int dlbandwidth) {
  for (int i = 0; i < 4; i++) {
...
unsigned int TdMtFfMacScheduler::LcActivePerFlow(uint16_t rnti) {
...
bool TdMtFfMacScheduler::HarqProcessAvailability(uint16_t rnti) {
...
uint8_t TdMtFfMacScheduler::UpdateHarqProcessId(uint16_t rnti) {
  NS_LOG_FUNCTION(this << rnti);
...
void TdMtFfMacScheduler::RefreshHarqProcesses() {
  NS_LOG_FUNCTION(this);
...
void TdMtFfMacScheduler::DoSchedDlTriggerReq(
...
void TdMtFfMacScheduler::DoSchedDlRachInfoReq(
...
void TdMtFfMacScheduler::DoSchedDlCqiInfoReq(
...
double TdMtFfMacScheduler::EstimateUlSinr(uint16_t rnti, uint16_t rb) {
...
void TdMtFfMacScheduler::DoSchedUlTriggerReq(
...
void TdMtFfMacScheduler::DoSchedUlNoiseInterferenceReq(
    const FfMacSchedSapProvider::SchedUlNoiseInterferenceReqParameters
        &params) {
  NS_LOG_FUNCTION(this);
}

void TdMtFfMacScheduler::DoSchedUlSrInfoReq(
    const FfMacSchedSapProvider::SchedUlSrInfoReqParameters &params) {
  NS_LOG_FUNCTION(this);
}

void TdMtFfMacScheduler::DoSchedUlMacCtrlInfoReq(
...
void TdMtFfMacScheduler::DoSchedUlCqiInfoReq(
...
void TdMtFfMacScheduler::RefreshDlCqiMaps() {
...
void TdMtFfMacScheduler::RefreshUlCqiMaps() {
  // refresh UL CQI  Map
...
void TdMtFfMacScheduler::UpdateDlRlcBufferInfo(uint16_t rnti, uint8_t lcid,
                                               uint16_t size) {
...
void TdMtFfMacScheduler::UpdateUlRlcBufferInfo(uint16_t rnti, uint16_t size) {
...
void TdMtFfMacScheduler::TransmissionModeConfigurationUpdate(uint16_t rnti,
                                                             uint8_t txMode) {
