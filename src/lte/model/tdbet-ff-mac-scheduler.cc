...
TdBetFfMacScheduler::~TdBetFfMacScheduler() { NS_LOG_FUNCTION(this); }

void TdBetFfMacScheduler::DoDispose() {
...
TypeId TdBetFfMacScheduler::GetTypeId() {
  static TypeId tid =
...
void TdBetFfMacScheduler::SetFfMacCschedSapUser(FfMacCschedSapUser *s) {
  m_cschedSapUser = s;
}

void TdBetFfMacScheduler::SetFfMacSchedSapUser(FfMacSchedSapUser *s) {
  m_schedSapUser = s;
}

FfMacCschedSapProvider *TdBetFfMacScheduler::GetFfMacCschedSapProvider() {
  return m_cschedSapProvider;
}

FfMacSchedSapProvider *TdBetFfMacScheduler::GetFfMacSchedSapProvider() {
  return m_schedSapProvider;
}

void TdBetFfMacScheduler::SetLteFfrSapProvider(LteFfrSapProvider *s) {
  m_ffrSapProvider = s;
}

LteFfrSapUser *TdBetFfMacScheduler::GetLteFfrSapUser() { return m_ffrSapUser; }

void TdBetFfMacScheduler::DoCschedCellConfigReq(
...
void TdBetFfMacScheduler::DoCschedUeConfigReq(
...
void TdBetFfMacScheduler::DoCschedLcConfigReq(
  ...
  for (std::size_t i = 0; i < params.m_logicalChannelConfigList.size(); i++) {
    ...
    if (it == m_flowStatsDl.end()) {
      ...
      m_flowStatsDl.insert(
          std::pair<uint16_t, tdbetsFlowPerf_t>(params.m_rnti, flowStatsDl));
      ...
      m_flowStatsUl.insert(
          std::pair<uint16_t, tdbetsFlowPerf_t>(params.m_rnti, flowStatsUl));
    }
  }
}

void TdBetFfMacScheduler::DoCschedLcReleaseReq(
...
void TdBetFfMacScheduler::DoCschedUeReleaseReq(
...
void TdBetFfMacScheduler::DoSchedDlRlcBufferReq(
...
void TdBetFfMacScheduler::DoSchedDlPagingBufferReq(
    const FfMacSchedSapProvider::SchedDlPagingBufferReqParameters &params) {
  NS_LOG_FUNCTION(this);
  NS_FATAL_ERROR("method not implemented");
}

void TdBetFfMacScheduler::DoSchedDlMacBufferReq(
    const FfMacSchedSapProvider::SchedDlMacBufferReqParameters &params) {
  NS_LOG_FUNCTION(this);
  NS_FATAL_ERROR("method not implemented");
}

int TdBetFfMacScheduler::GetRbgSize(int dlbandwidth) {
  for (int i = 0; i < 4; i++) {
...
unsigned int TdBetFfMacScheduler::LcActivePerFlow(uint16_t rnti) {
...
bool TdBetFfMacScheduler::HarqProcessAvailability(uint16_t rnti) {
...
uint8_t TdBetFfMacScheduler::UpdateHarqProcessId(uint16_t rnti) {
  NS_LOG_FUNCTION(this << rnti);
...
void TdBetFfMacScheduler::RefreshHarqProcesses() {
  NS_LOG_FUNCTION(this);
...
void TdBetFfMacScheduler::DoSchedDlTriggerReq(
...
void TdBetFfMacScheduler::DoSchedDlRachInfoReq(
...
void TdBetFfMacScheduler::DoSchedDlCqiInfoReq(
...
double TdBetFfMacScheduler::EstimateUlSinr(uint16_t rnti, uint16_t rb) {
...
void TdBetFfMacScheduler::DoSchedUlTriggerReq(
...
void TdBetFfMacScheduler::DoSchedUlNoiseInterferenceReq(
    const FfMacSchedSapProvider::SchedUlNoiseInterferenceReqParameters
        &params) {
  NS_LOG_FUNCTION(this);
}

void TdBetFfMacScheduler::DoSchedUlSrInfoReq(
    const FfMacSchedSapProvider::SchedUlSrInfoReqParameters &params) {
  NS_LOG_FUNCTION(this);
}

void TdBetFfMacScheduler::DoSchedUlMacCtrlInfoReq(
...
void TdBetFfMacScheduler::DoSchedUlCqiInfoReq(
...
void TdBetFfMacScheduler::RefreshDlCqiMaps() {
...
void TdBetFfMacScheduler::RefreshUlCqiMaps() {
  // refresh UL CQI  Map
...
void TdBetFfMacScheduler::UpdateDlRlcBufferInfo(uint16_t rnti, uint8_t lcid,
                                                uint16_t size) {
...
void TdBetFfMacScheduler::UpdateUlRlcBufferInfo(uint16_t rnti, uint16_t size) {
...
void TdBetFfMacScheduler::TransmissionModeConfigurationUpdate(uint16_t rnti,
                                                              uint8_t txMode) {
