...
FdMtFfMacScheduler::~FdMtFfMacScheduler() { NS_LOG_FUNCTION(this); }

void FdMtFfMacScheduler::DoDispose() {
...
TypeId FdMtFfMacScheduler::GetTypeId() {
  static TypeId tid =
...
void FdMtFfMacScheduler::SetFfMacCschedSapUser(FfMacCschedSapUser *s) {
  m_cschedSapUser = s;
}

void FdMtFfMacScheduler::SetFfMacSchedSapUser(FfMacSchedSapUser *s) {
  m_schedSapUser = s;
}

FfMacCschedSapProvider *FdMtFfMacScheduler::GetFfMacCschedSapProvider() {
  return m_cschedSapProvider;
}

FfMacSchedSapProvider *FdMtFfMacScheduler::GetFfMacSchedSapProvider() {
  return m_schedSapProvider;
}

void FdMtFfMacScheduler::SetLteFfrSapProvider(LteFfrSapProvider *s) {
  m_ffrSapProvider = s;
}

LteFfrSapUser *FdMtFfMacScheduler::GetLteFfrSapUser() { return m_ffrSapUser; }

void FdMtFfMacScheduler::DoCschedCellConfigReq(
...
void FdMtFfMacScheduler::DoCschedUeConfigReq(
...
void FdMtFfMacScheduler::DoCschedLcConfigReq(
...
void FdMtFfMacScheduler::DoCschedLcReleaseReq(
...
void FdMtFfMacScheduler::DoCschedUeReleaseReq(
...
void FdMtFfMacScheduler::DoSchedDlRlcBufferReq(
...
void FdMtFfMacScheduler::DoSchedDlPagingBufferReq(
    const FfMacSchedSapProvider::SchedDlPagingBufferReqParameters &params) {
  NS_LOG_FUNCTION(this);
  NS_FATAL_ERROR("method not implemented");
}

void FdMtFfMacScheduler::DoSchedDlMacBufferReq(
    const FfMacSchedSapProvider::SchedDlMacBufferReqParameters &params) {
  NS_LOG_FUNCTION(this);
  NS_FATAL_ERROR("method not implemented");
}

int FdMtFfMacScheduler::GetRbgSize(int dlbandwidth) {
  for (int i = 0; i < 4; i++) {
...
unsigned int FdMtFfMacScheduler::LcActivePerFlow(uint16_t rnti) {
...
bool FdMtFfMacScheduler::HarqProcessAvailability(uint16_t rnti) {
...
uint8_t FdMtFfMacScheduler::UpdateHarqProcessId(uint16_t rnti) {
  NS_LOG_FUNCTION(this << rnti);
...
void FdMtFfMacScheduler::RefreshHarqProcesses() {
  NS_LOG_FUNCTION(this);
...
void FdMtFfMacScheduler::DoSchedDlTriggerReq(
...
void FdMtFfMacScheduler::DoSchedDlCqiInfoReq(
...
double FdMtFfMacScheduler::EstimateUlSinr(uint16_t rnti, uint16_t rb) {
...
void FdMtFfMacScheduler::DoSchedUlTriggerReq(
...
void FdMtFfMacScheduler::DoSchedUlSrInfoReq(
    const FfMacSchedSapProvider::SchedUlSrInfoReqParameters &params) {
  NS_LOG_FUNCTION(this);
}

void FdMtFfMacScheduler::DoSchedUlMacCtrlInfoReq(
...
void FdMtFfMacScheduler::DoSchedUlCqiInfoReq(
...
void FdMtFfMacScheduler::RefreshDlCqiMaps() {
...
void FdMtFfMacScheduler::RefreshUlCqiMaps() {
  // refresh UL CQI  Map
...
void FdMtFfMacScheduler::UpdateDlRlcBufferInfo(uint16_t rnti, uint8_t lcid,
                                               uint16_t size) {
...
void FdMtFfMacScheduler::UpdateUlRlcBufferInfo(uint16_t rnti, uint16_t size) {
...
void FdMtFfMacScheduler::TransmissionModeConfigurationUpdate(uint16_t rnti,
                                                             uint8_t txMode) {
