...
/**
 * \brief The default component carrier manager that forwards all traffic, the
 * uplink and the downlink, over the primary carrier, and will not use secondary
 * carriers. To enable carrier aggregation feature, select another component
 * carrier manager class, i.e., some of child classes of
...
class NoOpComponentCarrierManager : public LteEnbComponentCarrierManager {
  /// allow EnbMacMemberLteMacSapProvider<NoOpComponentCarrierManager> class
  /// friend access
  friend class EnbMacMemberLteMacSapProvider<NoOpComponentCarrierManager>;
  /// allow MemberLteCcmRrcSapProvider<NoOpComponentCarrierManager> class friend
  /// access
  friend class MemberLteCcmRrcSapProvider<NoOpComponentCarrierManager>;
  /// allow MemberLteCcmRrcSapUser<NoOpComponentCarrierManager> class friend
  /// access
  friend class MemberLteCcmRrcSapUser<NoOpComponentCarrierManager>;
  /// allow MemberLteCcmMacSapUser<NoOpComponentCarrierManager> class friend
  /// access
...
protected:
  ...
  /**
   * \brief Function implements the function of the SAP interface of CCM
   * instance which is used by MAC to notify the PRB occupancy reported by
   * scheduler. \param prbOccupancy the PRB occupancy \param componentCarrierId
...
/**
 * \brief Component carrier manager implementation that splits traffic equally
 * among carriers.
 */
