...
TdTbfqFfMacScheduler::TdTbfqFfMacScheduler()
    : m_cschedSapUser(nullptr), m_schedSapUser(nullptr), m_nextRntiUl(0),
      bankSize(0) {
...
TdTbfqFfMacScheduler::~TdTbfqFfMacScheduler() { NS_LOG_FUNCTION(this); }

void TdTbfqFfMacScheduler::DoDispose() {
...
TypeId TdTbfqFfMacScheduler::GetTypeId() {
  static TypeId tid =
      TypeId("ns3::TdTbfqFfMacScheduler")
          ...
          .AddAttribute("DebtLimit", "Flow debt limit (default -625000 bytes)",
                        IntegerValue(-625000),
          ...
          .AddAttribute("CreditableThreshold",
                        ...
                        MakeUintegerAccessor(
                            &TdTbfqFfMacScheduler::m_creditableThreshold),
                        MakeUintegerChecker<uint32_t>())
...
void TdTbfqFfMacScheduler::SetFfMacCschedSapUser(FfMacCschedSapUser *s) {
  m_cschedSapUser = s;
}

void TdTbfqFfMacScheduler::SetFfMacSchedSapUser(FfMacSchedSapUser *s) {
  m_schedSapUser = s;
}

FfMacCschedSapProvider *TdTbfqFfMacScheduler::GetFfMacCschedSapProvider() {
  return m_cschedSapProvider;
}

FfMacSchedSapProvider *TdTbfqFfMacScheduler::GetFfMacSchedSapProvider() {
  return m_schedSapProvider;
}

void TdTbfqFfMacScheduler::SetLteFfrSapProvider(LteFfrSapProvider *s) {
  m_ffrSapProvider = s;
}

LteFfrSapUser *TdTbfqFfMacScheduler::GetLteFfrSapUser() { return m_ffrSapUser; }

void TdTbfqFfMacScheduler::DoCschedCellConfigReq(
...
void TdTbfqFfMacScheduler::DoCschedUeConfigReq(
...
void TdTbfqFfMacScheduler::DoCschedLcConfigReq(
...
void TdTbfqFfMacScheduler::DoCschedLcReleaseReq(
...
void TdTbfqFfMacScheduler::DoCschedUeReleaseReq(
...
void TdTbfqFfMacScheduler::DoSchedDlRlcBufferReq(
...
void TdTbfqFfMacScheduler::DoSchedDlPagingBufferReq(
    const FfMacSchedSapProvider::SchedDlPagingBufferReqParameters &params) {
  NS_LOG_FUNCTION(this);
  NS_FATAL_ERROR("method not implemented");
}

void TdTbfqFfMacScheduler::DoSchedDlMacBufferReq(
    const FfMacSchedSapProvider::SchedDlMacBufferReqParameters &params) {
  NS_LOG_FUNCTION(this);
  NS_FATAL_ERROR("method not implemented");
}

int TdTbfqFfMacScheduler::GetRbgSize(int dlbandwidth) {
  for (int i = 0; i < 4; i++) {
...
unsigned int TdTbfqFfMacScheduler::LcActivePerFlow(uint16_t rnti) {
...
bool TdTbfqFfMacScheduler::HarqProcessAvailability(uint16_t rnti) {
...
uint8_t TdTbfqFfMacScheduler::UpdateHarqProcessId(uint16_t rnti) {
  NS_LOG_FUNCTION(this << rnti);
...
void TdTbfqFfMacScheduler::RefreshHarqProcesses() {
  NS_LOG_FUNCTION(this);
...
void TdTbfqFfMacScheduler::DoSchedDlTriggerReq(
  ...
  for (auto it = m_flowStatsDl.begin(); it != m_flowStatsDl.end(); it++) {
    ...
    */
    ...
    double metric = (((double)(*it).second.counter) /
  ...
  if (itMax == m_flowStatsDl.end()) {
    ...
    for (int i = 0; i < rbgNum; i++) {
      if (rbgMap.at(i)) { // this RBG is allocated in RACH procedure
        continue;
      }
...
void TdTbfqFfMacScheduler::DoSchedDlRachInfoReq(
...
void TdTbfqFfMacScheduler::DoSchedDlCqiInfoReq(
...
double TdTbfqFfMacScheduler::EstimateUlSinr(uint16_t rnti, uint16_t rb) {
...
void TdTbfqFfMacScheduler::DoSchedUlTriggerReq(
...
void TdTbfqFfMacScheduler::DoSchedUlNoiseInterferenceReq(
    const FfMacSchedSapProvider::SchedUlNoiseInterferenceReqParameters
        &params) {
  NS_LOG_FUNCTION(this);
}

void TdTbfqFfMacScheduler::DoSchedUlSrInfoReq(
    const FfMacSchedSapProvider::SchedUlSrInfoReqParameters &params) {
  NS_LOG_FUNCTION(this);
}

void TdTbfqFfMacScheduler::DoSchedUlMacCtrlInfoReq(
...
void TdTbfqFfMacScheduler::DoSchedUlCqiInfoReq(
...
void TdTbfqFfMacScheduler::RefreshDlCqiMaps() {
...
void TdTbfqFfMacScheduler::RefreshUlCqiMaps() {
  // refresh UL CQI  Map
...
void TdTbfqFfMacScheduler::UpdateDlRlcBufferInfo(uint16_t rnti, uint8_t lcid,
                                                 uint16_t size) {
...
void TdTbfqFfMacScheduler::UpdateUlRlcBufferInfo(uint16_t rnti, uint16_t size) {
...
void TdTbfqFfMacScheduler::TransmissionModeConfigurationUpdate(uint16_t rnti,
                                                               uint8_t txMode) {
