...
//  Two Bridge test:
//      n0 <------> n1 <---> Bridge-n2 <---> Bridge-n3 <---> n4 (broadcast
//      links)
...
private:
  ...
  std::vector<uint8_t> m_firstInterface;  //!< Packets received on the 1st
                                          //!< interface at a given time.
  std::vector<uint8_t> m_secondInterface; //!< Packets received on the 2nd
                                          //!< interface at a given time.
};
