...
private:
  ...
  NetDeviceContainer
      m_hubDevices;       //!< NetDeviceContainer for the hub node NetDevices
  NodeContainer m_spokes; //!< NodeContainer for the spokes nodes
  NetDeviceContainer
      m_spokeDevices; //!< NetDeviceContainer for the spokes nodes NetDevices
  Ipv4InterfaceContainer
      m_hubInterfaces; //!< Ipv4InterfaceContainer for the hub IPv4 interfaces
  Ipv4InterfaceContainer m_spokeInterfaces; //!< Ipv4InterfaceContainer for the
                                            //!< spokes IPv4 interfaces
  Ipv6InterfaceContainer
      m_hubInterfaces6; //!< Ipv6InterfaceContainer for the hub IPv6 interfaces
  Ipv6InterfaceContainer m_spokeInterfaces6; //!< Ipv6InterfaceContainer for the
                                             //!< spokes IPv6 interfaces
};
