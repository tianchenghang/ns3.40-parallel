...
Bug780Test::Bug780Test()
    : TestCase("Test OLSR bug 780"), m_time(Seconds(200.0)), m_seq(0),
      m_recvCount(0) {}

Bug780Test::~Bug780Test() {}

void Bug780Test::DoRun() {
...
void Bug780Test::Receive(Ptr<Socket> socket) {
