...
private:
   ...
   *
   * \param object the object on which the attribute of type PointerValue
   * resides \param name the attribute name provided \param [in] value Ptr to
   * the ns3::Object pointed to by the attribute
   */
   ...
   * resides \param name the attribute name provided \param [in] vector the
   * ObjectPtrContainerValue corresponding to the named attribute
   */
  virtual void
