...
void cell_data_function_col_0_config_default(GtkTreeViewColumn *col,
                                             ...
                                             gpointer user_data);
/**
 * This is the action done when the user presses on the save button for the
 * Default attributes. It will save the config to a file.
 *
 * \param button (unused)
 * \param user_data
 */
...
/**
 * This is the action done when the user presses on the save button for the
 * Attributes. It will save the config to a file.
 *
 * \param button (unused)
 * \param user_data
 */
