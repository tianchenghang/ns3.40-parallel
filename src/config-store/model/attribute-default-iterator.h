 ...
 * \ingroup configstore
 *
 * \brief Iterator to iterate on the default values of attributes of an
 * ns3::Object
 */
...
public:
  ...
  /**
   * \brief This function will go through all the TypeIds and get only the
   * attributes which are explicit values (not vectors or pointer or arrays) and
   * apply StartVisitTypeId and VisitAttribute on the attributes in one TypeId.
