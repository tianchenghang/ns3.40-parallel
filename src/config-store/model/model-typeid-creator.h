...
struct ModelTypeid {
  ...
  /// The TypeId object and if it is an attribute, it's the TypeId object of the
  /// attribute
  TypeId tid;
...
public:
  ModelTypeidCreator();
  /**
   * \brief This method will iterate on typeIds having default attributes and
   * create a model for them, this model will be used by the view.
   *
